...
module pl_alu_ctrl (
    ...
    always_comb begin
        case (ALUOp)
            ...
            2'b11: begin                // I-type aritmetico: so Funct3 importa
                case (Funct3)           // (exceto shifts, onde Funct7[5] vale)
                    3'h0: Operation = 4'd01;  // ADDI -> ADD (ignora Funct7)
